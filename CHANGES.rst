...
* Use dask chunking when saving lazy signal instead of rechunking and leave the user decide what is the suitable chunking (`#2629 <https://github.com/hyperspy/hyperspy/pull/2629>`_)
