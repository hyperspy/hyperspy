...
class ImageObject(object):
    ...
    def _get_time(self, time):
        ...
        for string in formatting:
            try:
                ...
                pass
        _logger.info("Data saved with a location setting not supported: "
                     "Please report it to the HyperSpy developers, "
                     "(time: %s)"%time)
    ...
    def _get_date(self, date):
        ...
        for string in formatting:
            try:
                dt = datetime.strptime(date, string)
