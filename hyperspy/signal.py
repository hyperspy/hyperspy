...
class BaseSignal(FancySlicing):
    ...
    def decomposition(self, *args, **kwargs):
        """Delegates to hyperspy_ml.decompose()."""
        from hyperspy_ml import decompose

        return decompose(self, *args, **kwargs)

    def blind_source_separation(self, *args, **kwargs):
        """Delegates to hyperspy_ml.blind_source_separation()."""
        from hyperspy_ml import blind_source_separation

        return blind_source_separation(self, *args, **kwargs)

    def cluster_analysis(self, *args, **kwargs):
        """Delegates to hyperspy_ml.cluster_analysis()."""
        from hyperspy_ml import cluster_analysis

        return cluster_analysis(self, *args, **kwargs)

    def get_decomposition_model(self, *args, **kwargs):
        """Delegates to hyperspy_ml.get_decomposition_model()."""
        from hyperspy_ml import get_decomposition_model

        return get_decomposition_model(self, *args, **kwargs)

    def get_bss_model(self, *args, **kwargs):
        """Delegates to hyperspy_ml.get_bss_model()."""
        from hyperspy_ml import get_bss_model

        return get_bss_model(self, *args, **kwargs)

    def normalize_poissonian_noise(self, *args, **kwargs):
        """Delegates to hyperspy_ml.normalize_poissonian_noise()."""
        from hyperspy_ml import normalize_poissonian_noise

        return normalize_poissonian_noise(self, *args, **kwargs)

    def estimate_number_of_clusters(self, *args, **kwargs):
        """Delegates to hyperspy_ml.estimate_number_of_clusters()."""
        from hyperspy_ml import estimate_number_of_clusters

        return estimate_number_of_clusters(self, *args, **kwargs)

    def estimate_elbow_position(self, *args, **kwargs):
        """Delegates to hyperspy_ml.estimate_elbow_position()."""
        from hyperspy_ml import estimate_elbow_position

        return estimate_elbow_position(self, *args, **kwargs)
    ...
    def _deepcopy_with_new_data(
        ...
        try:
            ...
            if not copy_learning_results and hasattr(self, "learning_results"):
    ...
    def _load_dictionary(self, file_data_dict):
        ...
        if "learning_results" in file_data_dict and hasattr(self, "learning_results"):
