...
def test_get_low_loss_eel_line_scan_signal():
    s = ad.get_low_loss_eel_line_scan_signal()
    assert s.metadata.Signal.signal_type == 'EELS'


def test_get_core_loss_eel_line_scan_signal():
    s = ad.get_core_loss_eel_line_scan_signal()
    assert s.metadata.Signal.signal_type == 'EELS'
