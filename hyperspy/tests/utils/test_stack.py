...
class TestUtilsStack:
    ...
    def test_stack_default(self):
        ...
        assert_equal(test_axis, s.axes_manager[0].index_in_array)
        assert_equal(len(result_list), 3)
    ...
    def test_stack_of_stack(self):
        ...
        assert_false(hasattr(s4.original_metadata, 'stack_elements'))
        assert_equal(s4.metadata.General.title, 'test')
    ...
    def test_stack_bigger_than_ten(self):
        ...
        assert_equal(res[-1].metadata.General.title, 'test')
