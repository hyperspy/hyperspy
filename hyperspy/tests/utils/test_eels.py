...
def test_multiple_edges():
    ...
    assert len(edges) == 16
    assert edges == [
        'Mn_L3', 'Ra_N4', 'I_M4', 'Cd_M2', 'Mn_L2', 'V_L1', 'I_M5', 'Cd_M3',
        'In_M3', 'Xe_M5', 'Ac_N4', 'Ra_N5', 'Fr_N4', 'Ag_M2', 'F_K', 'Xe_M4',
        ]
...
def test_multiple_edges_ascending():
    ...
    assert len(edges) == 16
    assert edges == [
        'Ag_M2', 'Ra_N5', 'Fr_N4', 'Cd_M3', 'I_M5', 'V_L1', 'I_M4', 'Ra_N4',
        'Mn_L3', 'Cd_M2', 'Mn_L2', 'In_M3', 'Xe_M5', 'Ac_N4', 'F_K', 'Xe_M4',
        ]
...
def test_multiple_edges_descending():
    ...
    assert len(edges) == 16
    assert edges == [
        'F_K', 'Xe_M4', 'Ac_N4', 'Xe_M5', 'In_M3', 'Cd_M2', 'Mn_L2', 'Mn_L3',
        'Ra_N4', 'I_M4', 'V_L1', 'I_M5', 'Cd_M3', 'Ra_N5', 'Fr_N4', 'Ag_M2',
        ]
