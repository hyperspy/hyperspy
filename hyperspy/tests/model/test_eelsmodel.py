...
class TestCreateEELSModel:
    ...
    def test_auto_add_edges_true(self):
        ...
        assert_true("B_K" in cnames and "C_K" in cnames)

    def test_gos(self):
        m = self.s.create_model(auto_add_edges=True, GOS="hydrogenic")
        assert_true(m["B_K"].GOS._name == "hydrogenic")
...
class TestEELSModel:
    ...
    def test_suspend_auto_fsw(self):
        ...
        assert_equal(140, m["B_K"].fine_structure_width)
    ...
    def test_resume_fsw(self):
        ...
        m.enable_fine_structure()
        m.resolve_fine_structure()
        assert_equal(window, m["B_K"].fine_structure_width)
    ...
    def test_get_first_ionization_edge_energy_None(self):
        ...
        assert_is_none(self.m._get_first_ionization_edge_energy())
