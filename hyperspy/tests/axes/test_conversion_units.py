...
class TestUnitConversion:
    ...
    def test_get_compact_unit(self):
        ...
        nt.assert_almost_equal(self.uc.offset, 2.0, places=5)
        ...
        nt.assert_almost_equal(self.uc.offset, 0.0, places=5)
        ...
        nt.assert_almost_equal(self.uc.offset, 200.0, places=5)
        ...
        nt.assert_almost_equal(self.uc.offset, 0.5, places=5)
...
class TestDataAxis:
    ...
    def test_convert_to_compact_units(self):
        ...
        nt.assert_almost_equal(self.axis.offset, 5.0, places=5)
    ...
    def test_convert_to_units(self):
        ...
        nt.assert_almost_equal(self.axis.offset, 0.005, places=5)
    ...
    def test_units_not_supported_by_pint_no_warning_raised(self):
        ...
        nt.assert_almost_equal(self.axis.offset, 5E-09, places=15)
