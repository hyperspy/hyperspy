...
class TestBinaryOperatorsCase1:
    ...
    def setUp(self):
        self.s1 = Signal({'data' : np.arange(20).reshape(2, 2, 5)})
        self.s2 = Signal({'data' : np.arange(4).reshape(2, 2)})
        self.s2.axes_manager.set_signal_dimension(2)
        self.s3 = Signal({'data' : np.arange(4).reshape(1, 2, 2)})
...
class TestBinaryOperatorsCase2:
    ...
    def setUp(self):
        self.s1 = Signal({'data' : np.arange(20).reshape(2, 2, 5)})
        self.s2 = Signal({'data' : np.arange(5)})
        self.s3 = Signal({'data' : np.arange(5).reshape(1, 5)})
...
class TestBinaryOperatorsCase3:
    ...
    def setUp(self):
        self.s1 = Signal({'data' : np.arange(10).reshape(2, 5)})
        self.s1.axes_manager.set_signal_dimension(2)
        self.s2 = Signal({'data' : np.arange(6)})
...
class TestBinaryOperatorsCase4:
    ...
    """
    def setUp(self):
        self.s1 = Signal({'data' : np.arange(6)})
...
class TestUnaryOperators:
    ...
    def setUp(self):
        self.s1 = Signal({'data' : np.array((1,-1,4,-3))})
