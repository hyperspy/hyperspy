...
class EDSSpectrum(Spectrum):
    ...
    def add_lines(self,
        ...
        for line in lines:
            ...
            if element in elements_db:
                ...
                if subshell in elements_db[element]['Xray_lines']:
                    ...
                    if (elements_db[element]['Xray_lines'][subshell]['energy'] > 
                            end_energy):
    ...
    def _get_lines_from_elements(self,
        ...
        for element in elements:
            ...
            element_lines = []
            for subshell in elements_db[element]['Xray_lines'].keys():
            ...
            # Choose the best line
                ...
                for i, line in enumerate(element_lines):
                    if (elements_db[element]['Xray_lines']
    ...
    def get_lines_intensity(self,
        ...
        for Xray_line in Xray_lines:
            ...
            line_energy = elements_db[element]['Xray_lines'][line]['energy']
