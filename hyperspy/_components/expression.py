...
class Expression(Component):
    ...
    **kwargs
    ...
    def compile_function(self, module="numpy", position=False):
        ...
        variables = [x, y] if self._is2D else [x]
        self._f = sympy.utilities.lambdify.lambdify(variables + parameters, eval_expr,
        ...
        if self._compute_gradients:
            try:
                ...
                for p in parameters:
                    ...
                    f_grad = sympy.utilities.lambdify.lambdify(variables + parameters,
                                      grad_expr.evalf(),
                                      modules=module,
                                      dummify=False)
    ...
    def _separate_pseudocomponents(self):
        ...
        for para in self.free_parameters:
            ...
            free_pseudo_components[para.name] = {
                'function': sympy.utilities.lambdify.lambdify(variables + tuple(element_names),
