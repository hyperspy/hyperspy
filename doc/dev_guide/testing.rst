...
the figures, can result in failing tests.

.. note::
  
  To generate baseline images, the matplotlib and freetype version defined in
...
they are stored in the artifacts tab of the corresponding build:
