...
The HyperSpy :py:class:`~.api.signals.ComplexSignal` signal class
...
:py:class:`~.api.signals.ComplexSignal` (or to a subclass), which
...
The :py:meth:`~.api.signals.ComplexSignal.angle` function
...
:py:meth:`~.api.signals.ComplexSignal.angle` will return
...
With the :py:meth:`~.api.signals.ComplexSignal.unwrapped_phase`
...
be calculated using :py:meth:`~.api.signals.ComplexSignal.argand_diagram`
method, which returns the plot as a :py:class:`~.api.signals.Signal2D`.
...
signal via the
:py:meth:`~.api.signals.ComplexSignal2D.add_phase_ramp` method.
