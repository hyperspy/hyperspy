...
Conversion between zeta-factors and cross sections is possible using :py:meth:`~.misc.eds.util.edx_cross_section_to_zeta` or :py:meth:`~.misc.eds.util.zeta_to_edx_cross_section`.
