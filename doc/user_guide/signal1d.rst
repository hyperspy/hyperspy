...
The :py:meth:`~._signals.signal1D.Signal1DTools.integrate_in_range` method provides a GUI
...
A peak finding routine based on the work of T. O'Haver is available in HyperSpy through the :py:meth:`~._signals.signal1D.Signal1DTools.find_peaks1D_ohaver` method.
