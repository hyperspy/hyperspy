...
.. minigallery::
    :add-heading: Examples of creating signals from numpy arrays
...
.. Note::
    File saving examples show different formats and their use cases.

.. minigallery::
    :add-heading: Examples of file saving in different formats
    
    ../examples/io/file_saving_formats.py
...
.. Note::
    Metadata examples show how to access and modify signal metadata.

.. .. minigallery::
    .. :add-heading: Examples of metadata access and modification
    .. 
