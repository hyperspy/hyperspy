...
.. warning::
    ...
    :attr:`~.component.Parameter.std` attribute by setting variance equal to 1.
...
.. code-block:: python
   ...
   ... )
   >>> m.fit(weights="inverse_variance")
   >>> line.coefficients.value
...
a custom minimization function can be passed to the model:
