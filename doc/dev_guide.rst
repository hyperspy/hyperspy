...
``assert_almost_equal()``. Once, you have pushed your PR to the official 
HyperSpy repository, it can be usefull to check the coverage of your tests using the 
coveralls.io service links to the build of your PR. There should be a shortcut to it at the bottom of your PR on the github website.
