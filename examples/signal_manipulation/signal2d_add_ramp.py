...
x_profile_orig.axes_manager[0].scale = s.axes_manager[1].scale
x_profile_orig.axes_manager[0].units = s.axes_manager[1].units
x_profile_orig.axes_manager[0].name = 'X position'
...
y_profile_orig.axes_manager[0].scale = s.axes_manager[0].scale  
y_profile_orig.axes_manager[0].units = s.axes_manager[0].units
y_profile_orig.axes_manager[0].name = 'Y position'
