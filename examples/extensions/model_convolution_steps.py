...
#%%
# Create the "convolution axis" which added the necessary padding
convolution_axis = calculate_convolution1D_axis(
    f_signal.axes_manager.signal_axes[0], g_signal.axes_manager.signal_axes[0]
    )

#%%
# Calculate the model over the "convolution axis" and take the convolution
# with g_signal
...
convolved_signal.axes_manager.signal_axes.set(offset=200)
