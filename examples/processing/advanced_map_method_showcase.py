...
nav_shape = (6, 4)  # Navigation dimensions (reduced for faster computation)
sig_shape = (64, 64)  # Signal dimensions for 2D images (reduced for faster computation)
spectrum_length = 128  # For 1D spectral data (reduced for faster computation)
